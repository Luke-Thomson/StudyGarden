...
class ExampleGenerator {
    ...
    parseRef(line, exampleOnly = false) {
        ...
        let inc = (0, helpers_1.getBetweenBrackets)(line, "with");
        let exc = (0, helpers_1.getBetweenBrackets)(line, "exclude");
        const append = (0, helpers_1.getBetweenBrackets)(line, "append");
        let only = (0, helpers_1.getBetweenBrackets)(line, "only");
        const paginated = (0, helpers_1.getBetweenBrackets)(line, "paginated");
        const serializer = (0, helpers_1.getBetweenBrackets)(line, "serialized");
        if (serializer) {
            ...
            if (this.schemas[serializer].relations) {
                ...
                relations.forEach((relation) => {
                    const relationFields = this.schemas[serializer].relations[relation].map((field) => relation + "." + field);
    ...
    getSchemaExampleBasedOnAnnotation(schema, inc = "", exc = "", onl = "", first = "", parent = "", deepRels = [""]) {
        let props = {};
        ...
        for (const [key, value] of Object.entries(properties)) {
            ...
            if (rel !== "") {
                ...
                // deepRels.push(rel);
                propdata = this.getSchemaExampleBasedOnAnnotation(rel, inc, exc, onl, parent, parent === "" ? key : parent + "." + key, deepRels);
                if (propdata === null) {
                    continue;
                }
    ...
    exampleByField(field, type = "") {
        ...
        if (typeof ex[(0, lodash_1.snakeCase)(field)] !== "undefined") {
            return ex[(0, lodash_1.snakeCase)(field)];
        }
        return null;
    }
    getPaginatedData(line) {
