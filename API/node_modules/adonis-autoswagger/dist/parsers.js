...
exports.EnumParser = exports.InterfaceParser = exports.ValidatorParser = exports.ModelParser = exports.RouteParser = exports.CommentParser = void 0;
            ...
            if (trimmedLine.startsWith("enum") ||
                ...
                if (match) {
                    ...
                    enums[currentEnum] = {
                        ...
                        enum: [],
                        properties: {},
                        description: description || `${(0, lodash_1.startCase)(currentEnum)} enumeration`,
                    };
                    description = null;
                }
                continue;
